...
# =============================================================================
# 硬编码回退规则（与 harness-rules.yaml 内容一致）
# =============================================================================
...
FALLBACK_RULES: List[Dict[str, Any]] = [
    {
        ...
        "trigger_pattern": r"fdt_langgraph|futures_data_core|pipeline",
    ...
    },
    {
        ...
        "trigger_pattern": r"scripts/.*\.py|fdt_langgraph/.*\.py",
    ...
    },
    {
        ...
        "trigger_pattern": r"config/|settings\.json|\w+\.yaml",
    ...
    },
    {
        ...
        "trigger_pattern": r"degrade|circuit_breaker|fallback|retry",
    ...
    },
    {
        ...
        "trigger_pattern": r"trace_id|logger|metric|dashboard|health",
    ...
    },
    {
        ...
        "trigger_pattern": r"tests/|test_.*\.py",
    ...
    },
    {
        ...
        "trigger_pattern": r"v\d+\.\d+|Phase_\d+|milestone",
    ...
    },
    {
        ...
        "trigger_pattern": r"pipeline|flow|workflow|process",
    ...
    },
    {
        ...
        "type": "file_modified",
        "scope": "agents/*.md",
        "trigger_pattern": r"agents/.*\.py|agents/.*\.md",
...
def _is_triggered(rule: Dict[str, Any], changed_files: List[str]) -> bool:
    ...
    if pattern_str is None:
        # trigger_pattern=null 表示只有代码变更时才触发
        return has_code_changes(changed_files)
    try:
...
def print_results(results: Dict[str, Any]) -> None:
    ...
    print("\n" + "=" * 70)
    print("   FDT Harness 工程规范 — commit 前检查")
    print("=" * 70)
