...
| `decode_config.yaml` | `config/agents/decode_config.yaml` | 解码控制配置: 逐Agent温度/max_tokens/response_format/model (v9.23.0 模型差异化路由; v10.1.1 补充 news_sentiment_analyst 条目)|
